...
export default function Hero() {
  return (
    <div>
      ...
      {/* static icons */}
      <div className="hidden lg:block w-10 fixed bottom-0 lg:left-2 xl:left-10 z-10 ">
      ...
      <div className="hidden lg:block w-10 fixed bottom-0 left-auto right-2 xl:right-10 z-10 ">
